...
// 	protoc        (unknown)
// source: payment_service_contracts/grpc/pay.proto
...
func (PaymentMethod) Descriptor() protoreflect.EnumDescriptor {
	return file_payment_service_contracts_grpc_pay_proto_enumTypes[0].Descriptor()
}

func (PaymentMethod) Type() protoreflect.EnumType {
	return &file_payment_service_contracts_grpc_pay_proto_enumTypes[0]
}
...
func (PaymentMethod) EnumDescriptor() ([]byte, []int) {
	return file_payment_service_contracts_grpc_pay_proto_rawDescGZIP(), []int{0}
}
...
func (x *PayOrderRequest) Reset() {
	*x = PayOrderRequest{}
	mi := &file_payment_service_contracts_grpc_pay_proto_msgTypes[0]
...
func (x *PayOrderResponse) Reset() {
	*x = PayOrderResponse{}
	mi := &file_payment_service_contracts_grpc_pay_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PayOrderResponse) Descriptor() ([]byte, []int) {
	return file_payment_service_contracts_grpc_pay_proto_rawDescGZIP(), []int{1}
}
...
var File_payment_service_contracts_grpc_pay_proto protoreflect.FileDescriptor

const file_payment_service_contracts_grpc_pay_proto_rawDesc = "" +
	"\n" +
	"(payment_service_contracts/grpc/pay.proto\x12\n" +
	"payment.v1\"\x8f\x01\n" +
	...
	"\bPayOrder\x12\x1b.payment.v1.PayOrderRequest\x1a\x1c.payment.v1.PayOrderResponseB4Z2generated/payment_service_contracts/grpc;paymentv1b\x06proto3"

var (
	file_payment_service_contracts_grpc_pay_proto_rawDescOnce sync.Once
	file_payment_service_contracts_grpc_pay_proto_rawDescData []byte
)

func file_payment_service_contracts_grpc_pay_proto_rawDescGZIP() []byte {
	file_payment_service_contracts_grpc_pay_proto_rawDescOnce.Do(func() {
		file_payment_service_contracts_grpc_pay_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_payment_service_contracts_grpc_pay_proto_rawDesc), len(file_payment_service_contracts_grpc_pay_proto_rawDesc)))
	})
	return file_payment_service_contracts_grpc_pay_proto_rawDescData
}

var file_payment_service_contracts_grpc_pay_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_payment_service_contracts_grpc_pay_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_payment_service_contracts_grpc_pay_proto_goTypes = []any{
...
var file_payment_service_contracts_grpc_pay_proto_depIdxs = []int32{
...
func init() { file_payment_service_contracts_grpc_pay_proto_init() }
func file_payment_service_contracts_grpc_pay_proto_init() {
	if File_payment_service_contracts_grpc_pay_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_payment_service_contracts_grpc_pay_proto_rawDesc), len(file_payment_service_contracts_grpc_pay_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_payment_service_contracts_grpc_pay_proto_goTypes,
		DependencyIndexes: file_payment_service_contracts_grpc_pay_proto_depIdxs,
		EnumInfos:         file_payment_service_contracts_grpc_pay_proto_enumTypes,
		MessageInfos:      file_payment_service_contracts_grpc_pay_proto_msgTypes,
	}.Build()
	File_payment_service_contracts_grpc_pay_proto = out.File
	file_payment_service_contracts_grpc_pay_proto_goTypes = nil
	file_payment_service_contracts_grpc_pay_proto_depIdxs = nil
}
